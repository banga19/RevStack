...
- Name: pricing-to-checkout.spec.ts >> Pricing → PaymentCheckout → Success >> selects M-Pesa payment method and fills phone number
- Location: e2e/pricing-to-checkout.spec.ts:357:7
