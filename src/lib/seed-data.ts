export const planTasks = [
  ...
  { day: 1, title: "Recon & Initial Outreach to Ultimo Trading", description: "Visit ultimotradingltd.co.ke, do pre-pitch recon, send outreach", phase: "foundation", category: "outreach", priority: "critical" },
  ...
  { day: 3, title: "Build Voiceflow lead qualification chatbot", description: "8-block flow with scoring and 3 exit paths", phase: "foundation", category: "build", priority: "high" },
  { day: 4, title: "Build Make.com workflows", description: "5 scenarios: capture, follow-up, booking, no-show, reporting", phase: "foundation", category: "build", priority: "high" },
  ...
  { day: 8, title: "Discovery call with Ultimo Trading", description: "Present pipeline audit, share 5-slide report", phase: "foundation", category: "outreach", priority: "critical" },
  { day: 9, title: "Proposal submission to Ultimo", description: "$2,500/mo retainer proposal + setup fee", phase: "foundation", category: "outreach", priority: "critical" },
  { day: 10, title: "Follow-up sequence to 20 cold prospects", description: "Wholesale, import/export companies in Nairobi", phase: "foundation", category: "outreach", priority: "high" },
  { day: 11, title: "Create Canva one-pager & proposal deck", description: "Problem/solution/ROI template", phase: "foundation", category: "admin", priority: "medium" },
  ...
  { day: 16, title: "Close Ultimo Trading deal", description: "Contract signing, setup fee collection, kickoff", phase: "anchor", category: "outreach", priority: "critical" },
  { day: 17, title: "Ultimo onboarding Day 1", description: "System setup, team training, QMe queue configuration", phase: "anchor", category: "build", priority: "critical" },
  { day: 18, title: "Ultimo onboarding Day 2", description: "Make.com workflow customisation for Ultimo's needs", phase: "anchor", category: "build", priority: "critical" },
  { day: 19, title: "Ultimo go-live & monitoring", description: "System handoff, performance baseline measurement", phase: "anchor", category: "build", priority: "high" },
  { day: 20, title: "SEO article #3: WhatsApp Business API guide", description: "", phase: "anchor", category: "content", priority: "medium" },
  { day: 21, title: "Cold outreach batch #2 (20 prospects)", description: "Logistics & distribution companies", phase: "anchor", category: "outreach", priority: "high" },
  { day: 22, title: "Build case study from Ultimo results", description: "Before/after metrics for social proof", phase: "anchor", category: "content", priority: "high" },
  ...
  { day: 26, title: "Cold outreach batch #3 (20 prospects)", description: "E-commerce & retail companies", phase: "anchor", category: "outreach", priority: "high" },
  { day: 27, title: "Refine outreach messaging from response data", description: "A/B test subject lines, WhatsApp templates", phase: "anchor", category: "admin", priority: "medium" },
  ...
  { day: 30, title: "Month 1 review: financials, pipeline, content", description: "$2,500 target check, adjust plan", phase: "anchor", category: "admin", priority: "critical" },

  // Growth Phase (Days 31-55)
  { day: 31, title: "SEO article #7: Automated lead qualification guide", description: "Targeting trading companies", phase: "growth", category: "content", priority: "medium" },
  { day: 35, title: "Cold outreach batch #4 (30 prospects)", description: "Expanded geographic targeting", phase: "growth", category: "outreach", priority: "high" },
  { day: 40, title: "SEO article #10: Scaling B2B sales with AI chatbots", description: "", phase: "growth", category: "content", priority: "medium" },
  { day: 45, title: "Cold outreach batch #5 (30 prospects)", description: "Referral-introduced warm outreach", phase: "growth", category: "outreach", priority: "high" },
...
export const clients = [
  {
    ...
    company: "Ultimo Trading Ltd (Sokogate)",
    ...
    notes: "Anchor client. Sokogate B2B marketplace connecting Kenyan wholesalers to Chinese suppliers. Running full lead qualification, WhatsApp follow-up, QMe onboarding automation."
  },
  {
    name: "Prospect 1",
    ...
    notes: "Import/export company. Initial contact made, awaiting discovery call."
  },
  {
    name: "Prospect 2",
    ...
    monthlyRetainer: 1150,
    source: "cold-outreach",
    notes: "Logistics company interested in WhatsApp automation for shipment notifications."
  },
  {
    name: "Prospect 3",
    ...
    monthlyRetainer: 385,
    source: "seo",
    notes: "Found through website. Small import/export consultancy."
  },
  {
    ...
    setupFee: 1500,
    source: "referral",
    notes: "Referral from Ultimo. Electronics distributor needing lead qualification automation."
  },
]

export const revenueEntries = [
  { date: new Date("2026-01-15"), clientName: "Ultimo Trading Ltd", amount: 3000, type: "setup-fee", category: "enterprise", note: "Setup fee - chatbot + workflows + onboarding" },
  { date: new Date("2026-02-01"), clientName: "Ultimo Trading Ltd", amount: 2500, type: "retainer", category: "enterprise", note: "Month 1 retainer" },
  { date: new Date("2026-03-01"), clientName: "Ultimo Trading Ltd", amount: 2500, type: "retainer", category: "enterprise", note: "Month 2 retainer" },
  { date: new Date("2026-03-15"), clientName: "TechRetail Kenya Ltd", amount: 1500, type: "setup-fee", category: "growth", note: "Setup fee" },
  { date: new Date("2026-04-01"), clientName: "Ultimo Trading Ltd", amount: 2500, type: "retainer", category: "enterprise", note: "Month 3 retainer" },
...
export const campaignTemplates = [
  { name: "Cold Outreach - Wholesale", channel: "email", type: "cold", content: "Hi {{name}},\nI noticed {{company}} is in the wholesale space. At Ultimo Trading, we automated their lead qualification and saw X% improvement in response times. Would you be open to a 15-min chat about how this could work for you?" },
  { name: "Warm Follow-up - LinkedIn", channel: "linkedin", type: "warm", content: "Hi {{name}}, following up on our connection. We're helping B2B trading companies automate their lead follow-up and save 20+ hours/week. Keen to share a case study?" },
...
export const contentArticles = [
  ...
  { title: "How QMe Improves Client Onboarding for Service Businesses", keyword: "QMe client onboarding", status: "idea", week: 5, month: 2 },
  { title: "No-Code CRM Setup: A Step-by-Step Guide for Kenyan SMEs", keyword: "no-code CRM Kenya", status: "idea", week: 6, month: 2 },
...
export const documents = [
  ...
  { filename: "CANVA-TEMPLATE-BRIEFS.md", title: "Canva Template Briefs", description: "One-pager, proposal deck, and case study specs", category: "marketing", pages: 8 },
  { filename: "MAKE-DOT-COM-SCENARIO-BLUEPRINTS.md", title: "Make.com Scenario Blueprints", description: "5 scenarios module-by-module with error handling", category: "technical", pages: 16 },
  { filename: "WATI-DOT-IO-SEQUENCES-SETUP.md", title: "Wati.io Sequences Setup", description: "10 templates, Meta approval, branching logic, auto-reply flows", category: "technical", pages: 14 },
  { filename: "SEO-CONTENT-CALENDAR-90-DAY.md", title: "SEO Content Calendar 90-Day", description: "32 articles with outlines, keyword mapping, promotion plan", category: "marketing", pages: 16 },
]
