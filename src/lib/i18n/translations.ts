...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "pricing.trial": "All plans include a 3-day free trial. No credit card required.",
    ...
    "compare.check": "✅",
    "compare.cross": "❌",
    "compare.trialDays": "3-day free trial",
  ...
  sw: {
    ...
    "pricing.trial": "Mipango yote inajumuisha jaribio la siku 3 bure. Hakuna kadi ya mkopo inayohitajika.",
    ...
    "compare.check": "✅",
    "compare.cross": "❌",
    "compare.trialDays": "Jaribio la siku 3 bure",
