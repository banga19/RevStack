 ...
 *
 * Provides the current organization context to the component tree.
 * On signup, a user is automatically added to an organization.
  ...
  const fetchOrgs = useCallback(async () => {
    ...
    try {
      ...
      if (data.organizations) {
        ...
        // Use the stored preference or first org
