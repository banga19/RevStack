...
const navItems = [
  ...
  { href: "/korea/buyers", label: "Korea Buyers", icon: Building2 },
  { href: "/corridors", label: "Trade Corridors", icon: Globe },
  { href: "/west-africa", label: "West Africa Hub", icon: Globe },
  { href: "/afcfta", label: "AfCFTA Hub", icon: Globe },
  ...
  { href: "/campaigns/ab-testing", label: "A/B Testing", icon: FlaskConical },
  { href: "/outreach", label: "Outreach", icon: MessageSquare },
  { href: "/partners", label: "Partner Marketplace", icon: Handshake },
  { href: "/afcfta", label: "AfCFTA Hub", icon: Globe },
  { href: "/admin/finance", label: "Trade Finance", icon: Banknote },
