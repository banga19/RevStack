...
export default function OnboardingPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-primary/5 p-4 py-8">
      ...
      <div className="w-full max-w-2xl relative mt-16 md:mt-24">
        <div className="hidden sm:flex items-center justify-center gap-3 mb-12">
          {steps.map((s, i) => (
            <div key={s.id} className="flex items-center gap-3">
              <div
                className={cn(
                  "flex items-center gap-2.5 px-5 py-3 rounded-full text-sm font-semibold transition-all duration-300",
                  i === step
              ...
              {i < steps.length - 1 && (
                <div className={cn("w-12 h-0.5 transition-colors duration-300", i < step ? "bg-primary" : "bg-muted")} />
              )}
            </div>
          ))}
        </div>

        <Progress value={progress} className="h-2 mb-10 sm:hidden" />
        ...
        <Card className="backdrop-blur-sm bg-card/95 border-primary/10 shadow-2xl">
          <CardHeader className="text-center pb-2">
            <div className="flex justify-center mb-4">
              <div className="p-3 rounded-2xl bg-gradient-to-br from-primary to-primary/60 shadow-lg shadow-primary/20">
                ...
                {step === 5 && <CheckCircle2 className="h-8 w-8 text-white" />}
              </div>
            </div>
          </CardHeader>
          ...
          <CardContent className="p-8 sm:p-10 md:p-12">
              ...
              <div className="space-y-8 text-center">
                <div>
                  ...
                  <p className="text-muted-foreground text-lg">
                    We&apos;ll ask a few questions to tailor your Mapato experience. This helps us understand your goals and set you up for success.
                  </p>
                </div>
                <div className="grid gap-4 text-left">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-4 p-5 rounded-xl bg-muted/30">
                ...
                <p className="text-sm text-muted-foreground">This should take about 3 minutes</p>
              </div>
            )}
            ...
            {step === 1 && (
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-muted-foreground mt-2 text-lg">This helps us understand your context.</p>
                </div>
                <div className="space-y-5">
                  <div className="space-y-2">
                    <Label htmlFor="businessName">Business / Company name *</Label>
                    <Input id="businessName" value={formData.businessName} onChange={(e) => updateField("businessName", e.target.value)} placeholder="e.g. Acme Trading Ltd" className="h-11" autoFocus />
                  </div>
                  <div className="space-y-2">
            ...
            {step === 2 && (
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-muted-foreground mt-2 text-lg">Tell us about your primary goals and challenges.</p>
                </div>
                <div className="space-y-5">
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="secondaryGoals" value={formData.secondaryGoals} onChange={(e) => updateField("secondaryGoals", e.target.value)} placeholder="e.g. Improve response times, streamline onboarding, automate reporting..." className="min-h-[80px]" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="currentChallenges">Current challenges</Label>
                    <Textarea id="currentChallenges" value={formData.currentChallenges} onChange={(e) => updateField("currentChallenges", e.target.value)} placeholder="What's holding you back? e.g. Limited time, manual processes, low conversion rates..." className="min-h-[80px]" />
                  </div>
                </div>
              </div>
            )}
            ...
            {step === 3 && (
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-muted-foreground mt-2 text-lg">Help us understand your target audience and services.</p>
                </div>
                <div className="space-y-5">
                  <div className="space-y-2">
                    <Label htmlFor="targetAudience">Target audience</Label>
                    <Textarea id="targetAudience" value={formData.targetAudience} onChange={(e) => updateField("targetAudience", e.target.value)} placeholder="e.g. B2B trading companies in East Africa, wholesale distributors..." className="min-h-[80px]" />
                  </div>
                  <div className="space-y-2">
            ...
            {step === 4 && (
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-muted-foreground mt-2 text-lg">Help us scope the right solution for you.</p>
                </div>
                <div className="space-y-5">
                  <div className="space-y-2">
            ...
            {step === 5 && (
              <div className="space-y-5">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground mt-2">Here&apos;s a summary of your responses. You can go back to make changes.</p>
                </div>
                    ...
                    .map((item, i) => (
                      <div key={i} className="flex items-start gap-4 p-5 rounded-xl bg-muted/30">
                        <div className="flex-1">
                          ...
                          <p className="text-base font-semibold mt-1 capitalize">{item.value.replace(/-/g, " ")}</p>
                        </div>
                      </div>
                    ))}

                  {formData.budgetRange && (
                    <div className="mt-6 overflow-hidden rounded-2xl border border-orange-500/40 bg-gradient-to-br from-orange-500/20 via-amber-500/15 to-orange-600/10 shadow-[0_10px_35px_-15px_rgba(234,88,12,0.35)]">
                      <div className="p-5">
                        <p className="text-sm font-semibold text-orange-600 mb-3">Based on your budget, we recommend:</p>
                        <div className="rounded-xl bg-gradient-to-r from-orange-600 to-amber-500 p-4 text-white shadow-lg">
                          <div className="flex items-center justify-between gap-4">
                            <div>
                              <p className="text-xs uppercase tracking-wider text-orange-100">Recommended Plan</p>
                              <p className="text-2xl font-bold">{getSuggestedTier(formData.budgetRange)}</p>
                              <p className="text-sm mt-1 text-orange-50">${formatCurrency(getSuggestedPrice(formData.budgetRange))}/mo</p>
                            </div>
                            <Sparkles className="h-10 w-10 text-orange-100" />
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="flex items-center gap-3 p-4 rounded-lg bg-primary/5 border border-primary/10">
                  ...
                  <p className="text-sm text-muted-foreground">Ready to launch? We&apos;ll tailor your dashboard based on your responses.</p>
                </div>
              </div>
            )}
            ...
            <div className="flex items-center mt-8 pt-6 border-t border-border/50 justify-between">
              {step > 0 && (
              ...
              {step < steps.length - 1 ? (
                <Button onClick={handleNext} disabled={!canProceed()} className={step === 0 ? "mx-auto" : ""}>
