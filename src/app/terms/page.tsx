        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              By accessing or using Mapato (&ldquo;the Platform&rdquo;), you agree to be bound by these Terms & Conditions 
              (&ldquo;Terms&rdquo;). If you do not agree to these Terms, you may not access or use the Platform.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-3">
              These Terms constitute a legally binding agreement between you (&ldquo;User,&rdquo; &ldquo;Client,&rdquo; or &ldquo;You&rdquo;) and 
              Mapato (&ldquo;Company,&rdquo; &ldquo;We,&rdquo; &ldquo;Us,&rdquo; or &ldquo;Our&rdquo;). The Platform includes all associated services, 
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              Mapato provides an AI-powered business automation platform that enables B2B trading 
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              ...
              success-based fee (&ldquo;Success Fee&rdquo;) calculated as a percentage of revenue generated by the User 
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              8.1. The Platform is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without warranties of any kind, 
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">              9.3. Upon termination, the User&apos;s access to the Platform will be revoked. The Company will
